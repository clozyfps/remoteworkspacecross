...
public class Modelodm<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RightLeg = partdefinition.addOrReplaceChild("RightLeg",
				CubeListBuilder.create().texOffs(0, 0).addBox(-6.1F, 1.0F, -7.0F, 4.0F, 4.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(32, 32)
		...
		PartDefinition LeftLeg = partdefinition.addOrReplaceChild("LeftLeg",
				CubeListBuilder.create().texOffs(0, 19).addBox(2.1F, 1.0F, -7.0F, 4.0F, 4.0F, 15.0F, new CubeDeformation(0.0F)).texOffs(8, 17)
