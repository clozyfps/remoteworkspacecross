...
public class MarineEntity extends Monster {
	...
	public static void addLivingEntityToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(MobCategory.MONSTER).add(new MobSpawnSettings.SpawnerData(AnimecrossModEntities.MARINE.get(), 20, 4, 4));
	}

	public MarineEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AnimecrossModEntities.MARINE.get(), world);
	}
	...
	public static void init() {
		SpawnPlacements.register(AnimecrossModEntities.MARINE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
