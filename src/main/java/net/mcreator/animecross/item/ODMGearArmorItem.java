...
public abstract class ODMGearArmorItem extends ArmorItem {
	public ODMGearArmorItem(EquipmentSlot slot, Item.Properties properties) {
			...
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("left_leg", new Modelodm(Minecraft.getInstance().getEntityModels().bakeLayer(Modelodm.LAYER_LOCATION)).LeftLeg,
									"right_leg", new Modelodm(Minecraft.getInstance().getEntityModels().bakeLayer(Modelodm.LAYER_LOCATION)).RightLeg,
