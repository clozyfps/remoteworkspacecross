...
import net.mcreator.animecross.procedures.SlimeBootsTickEventProcedure;
...
public abstract class SlimeItem extends ArmorItem {
	public SlimeItem(EquipmentSlot slot, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public int getDefenseForSlot(EquipmentSlot slot) {
				return new int[]{8, 5, 6, 2}[slot.getIndex()];
			}
	...
	public static class Boots extends SlimeItem {
			...
			consumer.accept(new IItemRenderProperties() {
				...
				public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
					HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(),
							Map.of("left_leg", new Modelslime(Minecraft.getInstance().getEntityModels().bakeLayer(Modelslime.LAYER_LOCATION)).bb_main,
									"right_leg",
									new Modelslime(Minecraft.getInstance().getEntityModels().bakeLayer(Modelslime.LAYER_LOCATION)).bb_main, "head",
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "animecross:textures/slime.png";
		}

		@Override
		public void onArmorTick(ItemStack itemstack, Level world, Player entity) {
			SlimeBootsTickEventProcedure.execute(entity, itemstack);
		}
	}
}
